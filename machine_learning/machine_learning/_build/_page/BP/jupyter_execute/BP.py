...
# ដោយប្រើទំនាក់ទំនង $$u_k^{\left(l+1\right)}=\sum_{j}{w_{kj}^{\left(l+1\right)}z_j^{\left(l\right)}}=\sum_{j}{w_{kj}^{\left(l+1\right)}f\left(u_j^{\left(l\right)}\right)}$$ យើងបាន $$\partial u_k^{\left(l+1\right)}/\partial u_j^{\left(l\right)}=
# w_{kj}^{\left(l+1\right)}f^\prime\left(u_j^{\left(l\right)}\right) ។ $$ ហេតុនេះ 
...
# ងករណីនេះ អនុគមន៍សកម្មនៃថ្នាក់លទ្ធផលចុងក្រោយនៃFNNគឺជាអនុគមន៍ softmax ហេតុនេះ
# $$
